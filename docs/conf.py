...
copyright = u'2017{0}, Stephen Tiedemann'.format(
    u'-{0}'.format(year) if year > 2017 else u""
)
...
release = find_version("../src/ndeftool/__init__.py")
...
# of the sidebar.
html_logo = "images/ndeftool.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "images/ndeftool.ico"
...
latex_documents = [
  ('index', 'ndeftool.tex', u'ndeftool documentation',
...
man_pages = [
    ('index', 'ndeftool', u'ndeftool Documentation',
...
texinfo_documents = [
    ('index', 'ndeftool', u'ndeftool Documentation', u'Stephen Tiedemann',
     'ndeftool', 'Create or inspect NFC Data Exchange Format messages.',
     'Miscellaneous'),
]
